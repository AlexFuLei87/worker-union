...
/**
 *
 * 增加字段auditStatus、auditOpinion This class was generated by MyBatis Generator.
...
public class AttachmentDto implements Serializable {
	...
	public String toString() {
		return "AttachmentDto [auditStatus=" + auditStatus + ", auditOpinion=" + auditOpinion + ", id=" + id
				+ ", staffId=" + staffId + ", companyId=" + companyId + ", projectId=" + projectId + ", name=" + name
				+ ", contentType=" + contentType + ", size=" + size + ", path=" + path + ", type=" + type
				+ ", staffName=" + staffName + ", cstCreate=" + cstCreate + ", cstModified=" + cstModified + ", del="
				+ del + ", hashCode()=" + hashCode() + "]";
	}
