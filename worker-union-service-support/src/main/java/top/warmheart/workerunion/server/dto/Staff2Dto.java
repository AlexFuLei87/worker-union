...
/**
 * 企业用户 model增加字段资质qualification、年龄age、报建类型
 * 
 * @author seulad
 *
 */
public class Staff2Dto implements Serializable {
	/**
	 * serialVersionUID
	 */
	...
	public String toString() {
		return "Staff2Dto [id=" + id + ", companyId=" + companyId + ", name=" + name + ", sex=" + sex + ", birthday=" + birthday + ", age=" + age + ", jobNo=" + jobNo + ", nativePlace=" + nativePlace
				...
				+ ", cstModified=" + cstModified + ", del=" + del + ", qualification=" + qualification + ", type=" + type + ", hashCode()=" + hashCode() + "]";
	}
